...
public class _40_Print_Longest_Increasing_Subsequence_2 {
    ...
    public static ArrayList<Integer> Longest_Increasing_SubSeq_DPOptimized_2(int[] arr, int n) {
        int dp_2[] = new int[n];
    ...
    public static void solve(FastReader sc) {
        ...
        ans_ = Longest_Increasing_SubSeq_DPOptimized_2(arr, n);

        for(int i=0;i<ans_.size();i++){
            System.out.print(ans_.get(i)+" ");
        }
    }
