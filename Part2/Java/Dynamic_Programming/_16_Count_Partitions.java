...
public class _16_Count_Partitions {
    ...
    public static void solve(FastReader sc) {
        ...
        // here in question, s1-s2 = d ...(1) (We need to find 2 subsets with difference d)
        // we know that, s1+s2 = total ... (2)
        /*
        from 1 & 2,
            s2 = (total - d) / 2;

            So, we have to find
            if(s2 == (total-d)/2)  count++;
         */
