...
/*
Problem statement
Given an Integer n and a list arr. Sort the array using Selection sort algorithm.
*/
...
public:
    ...
    void SelectionSortBrute(vector<int>& arr){
        // selection sort, bringing lighter element to front
    ...
    void SelectionSortOptimal(vector<int>& arr){
...
void solve(){
    ...
    cout<<"Brute:\n";
    s.SelectionSortBrute(temp);

    temp.clear();
    for(auto it:arr) temp.push_back(it);

    cout<<"Optimal:\n";
    s.SelectionSortOptimal(temp);
}
